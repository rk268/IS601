...
class BurgerMachine:
    ...
    def run(self):
        ...
        # handle OutOfStockException
            ...
            print(f"The {self.currently_selecting.name} you choosed is currently out of stock, Please choose from the available stock")
        ...
        #rk268 3/26/23
            ...
            clean = input(" Please Enter 'clean' to trigger cleaning: ")
            if(clean.lower()=="clean"):
                self.clean_machine()
                print("The machine has been cleaned")
            else:
                print("The machine is not been cleaned")
            #rk268 3/26/23
        ...
        # handle InvalidChoiceException
            ...
            print(f"The item you choosed is an invalid for {self.currently_selecting.name} category, Please retype the expected name")
        ...
        #rk268 3/26/2023
            ...
            print(f"You have exceeded the number of items in the {self.currently_selecting.name} category, You are being moved to the next stage")
        ...
        # handle InvalidPaymentException
            ...
            print(f"Payment could not be processed, please exter exact amount")
